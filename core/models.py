...
class UserManager(BaseUserManager):
    def create_user(self, sdu_email, password=None, **extra_fields):
        ...
        user.is_staff = True  # Устанавливаем для обычных пользователей is_staff в False
        user.is_superuser = True  # Устанавливаем для обычных пользователей is_superuser в False
